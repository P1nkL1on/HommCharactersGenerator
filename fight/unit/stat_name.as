class fight.unit.stat_name{
		static var string_names:Array = new Array(
			...
			new Array(-22, 'pdmg', 'физ урн', 	'физический урон'),
			new Array(-23, 'mdmg', 'маг урн', 	'магический урон'),
			new Array(-24, 'mspd', 'скор', 	'скорость перемещения'),
			new Array(-25, 'eva', 	'укл', 	'уклонение'),
			new Array(-26, 'ini', 	'ини', 	'инициатива'),
			new Array(-27, 'pdef', 'физ защ', 	'физическая защита')
			new Array(-28, 'mdef', 'маг защ', 	'магическая защита')
		);
